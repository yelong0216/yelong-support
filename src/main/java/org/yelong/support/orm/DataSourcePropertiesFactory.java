...
public final class DataSourcePropertiesFactory {
	 ...
	 * 
	 * database.yelong.properties配置文件属性如下：
	 * 	datasource.yelong.url = ...
	 *  datasource.yelong.username=...
	 *  datasource.yelong.password=...
	...
	public static DataSourceProperties create(String configLocation,String prefix) throws Exception{
		return PropertiesWiredProcessorBuilder.builder(DataSourceProperties.class, PropertiesUtils.load(configLocation), prefix).wiredObj();
	}
