 ...
 * </p>
 */
public class MyBatisCombinationConditionFragment extends DefaultCombinationConditionSqlFragment
		implements MyBatisPlaceholderMap {
	...
	public MyBatisCombinationConditionFragment(SingleConditionSqlFragmentFactory singleConditionSqlFragmentFactory) {
	...
	protected void afterAddCondition(ConditionSqlFragmentWrapper conditionSqlFragmentWrapper) {
		...
		if (conditionFragment instanceof CombinationConditionSqlFragment) {
			if (conditionFragment instanceof MyBatisCombinationConditionFragment) {
				MYBATISPARAM.putMyBatisParamMap(
