 ...
 * java.util.Date类型适配器
 * 
 * 对于Date的属性在序列化或者反序列化时，遇到“空”值时使用填补值来返回
 * 
...
public class DateTypeAdapter extends TypeAdapter<Date>{
	...
	public static final String [] DEFAULT_PARSE_PATTERNS = {Dates.YYYY_MM_DD_HH_MM_SS,Dates.YYYY_MM_DD_BAR,Dates.YYYY_MM_DD_SLASH};
